...
| viewports     | Viewport configuration. Will be arrange left-to-right by width. Try to avoid changing the key, as this is used to identify the symbol. | object        | {<br/>&nbsp;&nbsp;narrow: {<br/>&nbsp;&nbsp;&nbsp;&nbsp; width: 320,<br/>&nbsp;&nbsp;&nbsp;&nbsp; height: 1200,<br/>&nbsp;&nbsp;&nbsp;&nbsp; symbolPrefix: 'Mobile/'<br/>&nbsp;&nbsp;}<br/>} |
